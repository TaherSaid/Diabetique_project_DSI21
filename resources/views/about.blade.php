                    ...
                    <div class="about_us_text">
                        ...
                        <div class="banner_item">
                            <div class="single_item">
                                <img src="image/icon/banner_1.svg" alt="">
                                <h5>Emergency</h5>
                            </div>
                            <div class="single_item">
                                <img src="image/icon/banner_2.svg" alt="">
                                <h5>Appointment</h5>
                            </div>
                            <div class="single_item">
                                <img src="image/icon/banner_3.svg" alt="">
                                <h5>Qualfied</h5>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-6 col-sm-6">
                                        <div class="single_our_depertment">
                                            <span class="our_depertment_icon"><img src="image/icon/feature_2.svg"
                                                    alt=""></span>
                                            <h4>Better Future</h4>
