            ...
            <div class="row align-items-center">
                <div class="col-lg-12">
                    <nav class="navbar navbar-expand-lg navbar-light">
                        ...
                        @if(!Auth::check())
                        <a class="btn_2 d-none d-lg-block" href="{{ route('login') }}" style="margin-top: 20px;">sign in</a>
                        @else
                        <a class="btn_2 d-none d-lg-block" href="/logout"
                        onclick="event.preventDefault();document.getElementById('logout-form').submit();" style="margin-top: 20px;">Logout</a>
                        @endif
